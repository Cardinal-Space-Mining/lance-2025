...
#define PROFILING_MODE_DISABLED 0  // all publishing gets compiled out
#define PROFILING_MODE_BASIC    1  // only basic metrics get published
#define PROFILING_MODE_ADVANCED 2  // all profiling metrics get published
...
#define PROFILING_DEFAULT_QOS                                           \
    ...
    #define PROFILING_MODE PROFILING_MODE_ADVANCED
#endif
...
void notify(const char* label1, const char* label2);
    ...
    #define PROFILING_NOTIFY_ALWAYS(label) util::profiling::notify(#label)
